...
class RiotFunctions {
  const RIOT_API_KEY = 'RGAPI-e018bc0a-2710-4825-81d4-d1e69fed623e';
  ...
  function getSummonerByName($tempName){
    $response = $this->riotAPI->get('/api/lol/oce/v1.4/summoner/by-name/'.$tempName);
    return $response;
  }
  ...
  function getChampById($champId1){
    $response = $this->riotAPI->get('/api/lol/oce/v1.2/champion/'.$champId1);
    return $response;
  }
